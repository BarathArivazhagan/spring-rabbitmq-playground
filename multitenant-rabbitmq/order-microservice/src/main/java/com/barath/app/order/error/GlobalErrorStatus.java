...
public enum GlobalErrorStatus {
	 ...
	 * @deprecated in favor of {@link #FOUND} which will be returned from {@code AMCErrorStatus.valueOf(302)}
	 */
	@Deprecated
	 ...
	 * @deprecated in favor of {@link #PAYLOAD_TOO_LARGE} which will be returned from {@code AMCErrorStatus.valueOf(413)}
	 */
	@Deprecated
	 ...
	 * @deprecated in favor of {@link #URI_TOO_LONG} which will be returned from {@code AMCErrorStatus.valueOf(414)}
	 */
	@Deprecated
	...
	GlobalErrorStatus(int value, String reasonPhrase) {
		this.value = value;
	 ...
	 * {@link org.springframework.http.GlobalErrorStatus.Series#INFORMATIONAL}.
	...
	/**
	 * Whether this status code is in the HTTP series
	 * {@link org.springframework.http.GlobalErrorStatus.Series#SUCCESSFUL}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	...
	/**
	 * Whether this status code is in the HTTP series
	 * {@link org.springframework.http.GlobalErrorStatus.Series#REDIRECTION}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	...
	/**
	 * Whether this status code is in the HTTP series
	 * {@link org.springframework.http.GlobalErrorStatus.Series#CLIENT_ERROR}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	...
	/**
	 * Whether this status code is in the HTTP series
	 * {@link org.springframework.http.GlobalErrorStatus.Series#SERVER_ERROR}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	 ...
	 */
	public static GlobalErrorStatus valueOf(int statusCode) {
		for (GlobalErrorStatus status : values()) {
	 ...
	 * <p>Retrievable via {@link GlobalErrorStatus#series()}.
	 */
	public enum Series {
		...
		public static Series valueOf(GlobalErrorStatus status) {
